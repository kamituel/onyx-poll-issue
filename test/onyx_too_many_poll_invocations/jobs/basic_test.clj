(ns onyx-too-many-poll-invocations.jobs.basic-test
    (:require [aero.core :refer [read-config]]
              ...
              onyx-too-many-poll-invocations.tasks.math
...
(deftest basic-test
  (testing "That we can have a basic in-out workflow run through Onyx"
    (let [{:keys [env-config
          ...
          job (onyx-too-many-poll-invocations.jobs.basic/basic-job {:onyx/batch-size 10
